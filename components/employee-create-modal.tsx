  ...
  function handleSubmit(formData: FormData) {
    ...
    startTransition(async () => {
      try {
        ...
        setError(
          getErrorMessage(err, 'Beim Speichern des Mitarbeiters ist ein Fehler aufgetreten.')
        )
      }
    })
  }
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-sm text-slate-600">
                  Lege einen neuen Mitarbeiter mit Stammdaten an.
                </p>
              </div>
            ...
            <form action={handleSubmit} className="mt-6 space-y-5">
              ...
              <div>
                ...
                <input
                  name="employer"
                  type="text"
                  placeholder="z. B. intern oder Müller Bau GmbH"
                  className="w-full rounded-2xl border border-slate-200 bg-white/70 px-4 py-3 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-blue-300 focus:ring-2 focus:ring-blue-100"
                />
              </div>
              ...
              <div className="flex items-center justify-end gap-3 pt-2">
                ...
                >
                  {isPending ? 'Speichern...' : 'Mitarbeiter speichern'}
                </button>
              </div>
            </form>
          </div>

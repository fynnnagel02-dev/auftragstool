  ...
  return (
    <>
      ...
      <AppModal
        ...
        title="Filtergruppe verwalten"
        subtitle="Bearbeite Name und Beschreibung und ordne Mitarbeiter der Gruppe zu."
        ...
        <div className="grid gap-6 xl:grid-cols-[0.42fr_0.58fr]">
          <div className="space-y-5">
            ...
            <div className="rounded-2xl border border-red-200 bg-red-50/70 p-4">
              <p className="text-sm font-medium text-red-800">Gruppe löschen</p>
              <p className="mt-2 text-sm text-red-700">
                Diese Aktion entfernt die Gruppe inklusive aller Zuordnungen.
              </p>
              <button
                type="button"
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-slate-600">
              Alle markierten Mitarbeiter werden dieser Filtergruppe zugeordnet.
            </p>
